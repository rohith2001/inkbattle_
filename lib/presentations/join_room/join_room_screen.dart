...
class _JoinRoomScreenState extends State<JoinRoomScreen> {
  ...
  Future<void> _handleJoinRoom() async {
    ...
    try {
      ...
      final roomDetailsResult = await _roomRepository.getRoomByCode(roomCode: code);
      ...
      if (!hasEnoughCoins) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('${AppLocalizations.insufficientCoinsJoin} ($entryCost)'),
      ...
      result.fold(
        ...
        (roomResponse) async {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('${AppLocalizations.successfullyJoinedRoom} ($entryCost ${AppLocalizations.coins})'),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: _isLoading
                              ...
                              : TextWidget(
                                  text: "${AppLocalizations.joinRoom} (100 ${AppLocalizations.coins})",
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.bold,
                                  color: AppColors.whiteColor,
                                ),
