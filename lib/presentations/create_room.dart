...
//                 onTap: () {
//                   if (isFormComplete) {
//                     // This is just a demo screen - actual room creation should use CreateRoomScreen
//                     ScaffoldMessenger.of(context).showSnackBar(
//                       const SnackBar(content: Text("Use the proper Create Room screen for actual room creation")),
//                     );
//                   } else {
//                     ScaffoldMessenger.of(context).showSnackBar(
...
//                       SizedBox(width: 8.w),
//                       Text(
//                         isFormComplete ? "Let's go! Room is live" : "$coins",
//                         style: TextStyle(
//                           fontSize: 18.sp,
