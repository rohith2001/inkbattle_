...
//   final List<String> languages = ["English", "Hindi", "Marathi", "Telugu"];
//   final List<String> scripts = ["Latin", "Devanagari", "Telugu"];
//   final List<String> countries = ["India", "USA", "UK", "All"];
//   final List<String> points = ["120", "250", "400", "500"];
//   final List<String> categories = ["Fruits", "Animals", "Food", "Movies"];
...
//                   TextWidget(
//                     text:
//                         widget.isTeamMode ? "Create Team Room" : "Create Room",
//                     fontSize: 20.sp,
//                     fontWeight: FontWeight.bold,
//                     color: AppColors.whiteColor,
//                   ),
...
//                         child: TextWidget(
//                           text: "Create a room and configure settings in the lobby",
//                           fontSize: 14.sp,
...
//                         padding: EdgeInsets.symmetric(horizontal: 20.w),
//                         child: TextWidget(
//                           text: "You'll be able to share the room code with friends after creation",
//                           fontSize: 12.sp,
//                           color: Colors.grey,
//                           textAlign: TextAlign.center,
//                         ),
